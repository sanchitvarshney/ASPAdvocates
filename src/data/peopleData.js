...
`,
  ...
  {
    id: 3,
    image: "/peopleImg/Irith-Kapur.jpg",
    name: "Irith Kapur",
    bio: "Regulatory & Disputes",
    description: `Irith is a part of firm’s Regulatory & Disputes Litigation team. His practice focuses in helping businesses comply with sector-specific laws, industry standards, and government regulations to mitigate legal and reputational risk. Irirth advises on compliance frameworks, and works with regulators like FSSAI, CDSCO, LM and BIS. His work often involves managing investigations, conducting internal audits, and ensuring adherence to data protection, financial, and environmental law. 
...
`,
  ...
  {
    id: 7,
    image: "/peopleImg/prashant.jpg",
    name: "Prashant Kumar",
    bio: "Dispute Resolution & Regulatory",
    description: `Prashant is part of the firm’s Employment, Regulatory and Disputes practice.  He specializes in the legal relationship between employers and employees, covering hiring, workplace policies, compliance, and termination. Prashant focuses on advisory and litigation including disputes, discrimination cases and union issues. 

Prashant’s work also focuses on navigating the intricate landscape of government regulations, compliance frameworks, and industry-specific policies, serving as a vital link between Clients and regulators including the Reserve Bank of India (RBI), Securities and Exchange Board of India (SEBI), and Competition Commission of India (CCI). 

Prashant also extensively works for Fintech & Financial Services, Corporate & Securities Law and Sectoral Regulations.  
`,
    mobile: "+91 8299 491 624",
    email: "asp@asplaw.in",
  },
  {
    id: 8,
