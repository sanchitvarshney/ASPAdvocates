...
const AnimatedBtn = ({children,toggleState,toggleValue}) => {
  return (
    <Wrapper>
      <button class="cta" onClick={()=>toggleState &&toggleState(toggleValue)} data-aos="fade-right" data-aos-delay="400" data-aos-duration="1000">
